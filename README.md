# 42.lem-ipc
The goal of this project is to make two (or more) processes communicate and interact using the API that UNIX System V provide.

This will be a mini game where 2 teams will faces each others in a battle on a 2D board
...
TEAM_ID must be a positive number between 0 and NB_MAX_TEAMS (10 per default, located in `game_utils.h`).

If TEAM_ID equals 0, the application will start in graphic mode.
